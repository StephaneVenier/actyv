...
type SessionDebugBoundaryProps = {
...
type SessionDebugBoundaryState = {
  error: Error | null;
  errorInfo: React.ErrorInfo | null;
};

export class SessionDebugBoundary extends React.Component<
  SessionDebugBoundaryProps,
  SessionDebugBoundaryState
> {
  state: SessionDebugBoundaryState = {
    error: null,
    errorInfo: null,
  };
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error(`[${this.props.componentName}] render error on ${this.props.routeLabel}`, {
      error,
      errorInfo,
  ...
  render() {
    ...
    const stack = error?.stack || errorInfo?.componentStack || 'No stack available';
            ...
            <section>
              ...
              <pre style={preStyle}>
                {safeStringify({
                  ...
                  sessionId: this.props.sessionId,
                  supabaseSnapshot: this.props.snapshot ?? null,
                })}
              </pre>
            </section>
          </div>
