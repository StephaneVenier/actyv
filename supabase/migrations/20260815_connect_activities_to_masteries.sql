...
revoke all on function public.resolve_activity_mastery_sport(text) from public;
revoke all on function public.resolve_activity_mastery_sport(text) from anon;
revoke all on function public.resolve_activity_mastery_sport(text) from authenticated;
